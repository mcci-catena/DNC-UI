...
const OrgHomeSpotCard = ({ isLoading }) => {
        ...
        <>
            {isLoading ? (
                ...
                <CardWrapper border={false} content={false}>
                                ...
                                <Grid container justifyContent="space-between">
                                    ...
                                    <Grid item>
                                        <Avatar
                                            ...
                                            aria-controls="AddLocationAltSharpIcon"
                                            aria-haspopup="true"
                                            onClick={handleClick}
                                        >
                                            <AddLocationAltSharpIcon />
                    ...
                    <CardActions sx={{ p: 1 }}>
                        <CustomButton size="small" disableElevation onClick={handleViewAllSpots}>
                            View All Spots
                            <AddLocationAltSharpIcon sx={{ color: '#fff', marginLeft: '8px' }} />
                        </CustomButton>
                    </CardActions>
                </CardWrapper>
            )}
...
OrgHomeSpotCard.propTypes = {
    isLoading: PropTypes.bool
};

export default OrgHomeSpotCard;
