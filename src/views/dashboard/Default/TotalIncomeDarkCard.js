...
import { Avatar, Box, Grid, Menu, MenuItem, Typography, Button, CardActions } from '@mui/material';
                        ...
                        <Grid container direction="column">
                            ...
                            <Grid item sx={{ mb: 1.25 }}>
                                <CardActions sx={{ p: 1.25 }}>
                                    <CustomButton style={{ marginLeft: '-1%' }} size="small" disableElevation onClick={handleViewAllSpots}>
                                        View All Spots
