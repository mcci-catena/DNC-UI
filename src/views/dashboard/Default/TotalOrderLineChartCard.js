...
import { Avatar, Box, Grid, Menu, MenuItem, Typography, CardActions, Button } from '@mui/material';
                            ...
                            <Grid item sx={{ mb: 1.25 }}>
                                <CardActions sx={{ p: 1.25 }}>
                                    <CustomButton
                                        ...
                                        size="small"
                                        disableElevation
                                        onClick={handleViewAllGateways}
                                    >
                                        View All Gateways
                                        <ArrowUpwardIcon sx={{ color: 'viloet' }} /> {/* Set your desired icon color */}
                                    </CustomButton>
                                </CardActions>
                            </Grid>
                        </Grid>
